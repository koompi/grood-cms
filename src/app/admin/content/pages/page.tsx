...
import { BulkActionsToolbar, defaultPageActions } from '@/components/admin/BulkActionsToolbar'
          ...
          <div className="divide-y divide-gray-100">
            {filteredPages.map((page) => {
              ...
              return (
                <div 
                  key={page.id} 
                  className={`p-4 hover:bg-gray-50/50 transition-colors group ${selectedIds.has(page.id) ? 'bg-violet-50/50' : ''}`}
                >
